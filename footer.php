...
<footer class="w3l-footer-66">
				...
				<div class="row footer-top">
					<div class="col-lg-4 footer-grid_section_w3layouts pr-lg-5">
						<h2 class="logo-2 mb-lg-4 mb-3">
							<a class="navbar-brand" href="index.html"><span>BD</span>MS</a>
		...
		<div class="cpy-right py-3">
			<p class="text-center">© 2024 BDMS. All rights reserved | Design by
				<a href="http://w3layouts.com"> Rathod Bharatsinh</a>
			</p>
		</div>
		<!-- move top -->
